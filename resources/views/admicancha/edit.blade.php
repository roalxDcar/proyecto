                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @endforeach
                                        <hr>
                                        <form action="{{ route('area.update',$cancha->id) }}" method="post" novalidate="novalidate">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="nombre" name="nombre" value="{{ $cancha->nombre }}" type="text" class="form-control" aria-required="true" value="" autocomplete="off">
                                            </div>
