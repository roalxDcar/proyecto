...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{!! assets('asets/css/bootstrap.min.css') !!}">
    ...
    <link rel="stylesheet" href="{!! assets('assets/css/rangeslider.css') !!}">
  ...
  <script src="{!! assets('assets/js/jquery-migrate-3.0.1.min.js') !!}"></script>
